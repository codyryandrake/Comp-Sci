...
public class Math {
	...
	{
		if (x < 0) x *= -1; //Only in the case of negative doubles, multiply the double by -1
	...
	{
		double temp = dist(array1[0], array2[0]); //<temp> should initialize as the smallest possible value
