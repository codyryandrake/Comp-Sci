...
public class ketchupDemo {

	public static void main(String[] args) throws IOException
	{
		System.out.println("Welcome to the ketchupCalc Program."); //Greet the user.
		...
		System.out.println("File found! Initializing ketchupCalc..."); 
		System.out.println();
		...
		System.out.println("ketchupCalc complete!");
		System.out.println();
